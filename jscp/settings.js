...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|AKHI|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.png', content: '' }, // Front cover
        { image: './image/Birthday!/photo1.png', content: 'Dear Akhi, you bring so much joy and happiness! 💕' },
        { image: './image/Birthday!/photo2.png', content: 'Your smile lights up every room you enter! ✨' },
        { image: './image/Birthday!/photo3.png', content: 'You are such an amazing and beautiful person! 🌸' },
        { image: './image/Birthday!/photo4.png', content: 'Your kindness and warmth touch hearts! 💖' },
        { image: './image/Birthday!/photo5.png', content: 'Wishing you the most wonderful birthday ever! 🎉' },
        { image: './image/Birthday!/photo6.png', content: 'May all your dreams come true! ⭐' },
        { image: './image/Birthday!/photo7.png', content: 'You deserve all the happiness! 🌈' },
        { image: './image/Birthday!/photo8.png', content: 'Love you so much! Have the best day! ❤️🎂' },
        { image: './image/Birthday!/9.png', content: '' } // End cover
    ],
    enableBook: true,
    enableHeart: true,
    isSave: false,
